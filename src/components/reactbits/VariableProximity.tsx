...
const VariableProximity = forwardRef<HTMLSpanElement, VariableProximityProps>((props, ref) => {
  ...
  useAnimationFrame(
    ...
    }, [containerRef, mousePositionRef, fromFontVariationSettings, parsedSettings, radius, calculateFalloff])
  );
  ...
  return (
    <span ref={ref} className={`inline ${className}`} style={{ display: 'inline', ...style }} {...restProps}>
